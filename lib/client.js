            ...
            React.createElement('table', { className: 'dsb-u-table' },
              ...
              React.createElement('tbody', null,
                records.map((r, i) => React.createElement('tr', { key: (r.at || 0) + '-' + i },
                  ...
                  React.createElement('td', { className: 'dsb-u-product' }, r.provider || r.product || 'DSH'),
                  React.createElement('td', { className: 'dsb-u-cost', title: r.cost == null ? '非 DeepSeek 模型（如 GLM），暂无价目表，未计费' : '' }, fmt(r.cost, currency))))))),
