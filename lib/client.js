...
function apply(ctx) {
  ...
  function UsageView() {
    ...
    const unpriced = records.filter((r) => !r || r.cost == null).length
    ...
    return React.createElement('div', null,
      ...
      React.createElement('div', { className: 'dsb-u-foot' },
        React.createElement('span', null, label + t('count').replace('{n}', records.length) + (unpriced > 0 ? t('unpricedCount').replace('{n}', unpriced) : '')),
